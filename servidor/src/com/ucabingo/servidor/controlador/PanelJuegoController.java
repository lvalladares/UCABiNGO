...
import com.ucabingo.servidor.modelo.Matriz;
import com.ucabingo.servidor.vista.PanelJuego;
...
public class PanelJuegoController {
	...
	private void mostrarCarton(int cantidadCartones) {
		...
		if (cantidadCartones == 1) {
	        ...
	        matriz.LlenarMariz(arreglo1, this.vista.panel1);
			...
			Matriz matriz = new Matriz();
	        matriz.LlenarMariz(arreglo1, this.vista.panel1, this.vista.panel2);
			...
			Matriz matriz = new Matriz();
	        matriz.LlenarMariz(arreglo1, this.vista.panel1, this.vista.panel2, this.vista.panel3);
